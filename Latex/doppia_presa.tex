...
Eseguendo il codice fino a convergenza dei residui, la norma dell'entropia vale (si riporta sempre
l'$l_c$ associato; i tre valori sono impilati per chiarezza):
\begin{align*}
  u_{h}   &= 1.443\times10^{-2} \qquad (l_c = 0.25,\ \text{M3},\ 65\,130\ \text{nodi}) \\
  u_{2h}  &= 1.651\times10^{-2} \qquad (l_c = 0.50,\ \text{M2},\ 16\,564\ \text{nodi}) \\
  u_{4h}  &= 1.973\times10^{-2} \qquad (l_c = 1.00,\ \text{M1},\ 4\,320\ \text{nodi})
\end{align*}
con rapporto di diradamento $r=2$ (dimezzando $l_c$ il numero di nodi quadruplica, quindi
$r=(N_{\rm fine}/N_{\rm rada})^{1/2}\approx2$).
