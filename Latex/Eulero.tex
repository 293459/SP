...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{schemi_esplicativi/strutture.png}
    \caption{Rappresentazione grafica delle strutture dati utilizzate per memorizzare le informazioni sui nodi, elementi, interfacce e bordi.}
\end{figure}
