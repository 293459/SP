...
\section{Logica di Raffinamento e Algoritmi di Generazione}
...
% ------------------------------------------------------------
\section{Il Software \texttt{gmsh}}
...
% ------------------------------------------------------------
\section{Griglie Strutturate e Non Strutturate}
...
\subsection{Griglie Non Strutturate}
...
\section{Struttura del File \texttt{.msh}: Gli Elementi}
