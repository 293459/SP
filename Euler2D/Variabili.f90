...
save
		...
		Integer:: k,kinf,kout,kfinal ! variabili intere per gestire i passi temporali e la frequenza di output --  k indice temporale
		...
		real(4)::periodo !passo lungo y in caso di problema periodico   -- attivo solo in caso di problemi periodici
		character(100)::mesh_file ! Nome del file mesh in formato Gmsh 2  -- ad esempio bumpo.msh
		...
		type(tipo_nodo),dimension(:), allocatable  :: nodo  ! array dei nodi -- vettore allocabile e tipo derivato
